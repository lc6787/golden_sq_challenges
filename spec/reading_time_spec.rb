...
# establish method - reading_time
# take string argument passed to method and split it by spaces
# count the words
# divide by 50 (words read per minute)
# return number of minutes would take to read text as string
...
RSpec.describe "grammar_checker method" do
  ...
  it "checks first and last characters are BOTH grammatically incorrect" do
    text = "the weather is clear outside"
